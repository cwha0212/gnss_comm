...
namespace gnss_comm
{
    ...
    * args   : const GnssEphemMsg &  gnss_ephem_msg  I   Ephemeris ros message
    * return : cooresponding ephemeris struct
    *-----------------------------------------------------------------------------------*/
    EphemPtr msg2ephem(const gnss_comm::msg::GnssEphemMsg & gnss_ephem_msg);
    ...
    * args   : const GnssGloEphemMsg & gnss_glo_ephem_msg  I   GLONASS Ephemeris ros message
    * return : cooresponding GLONASS ephemeris struct
    *--------------------------------------------------------------------------------------*/
    GloEphemPtr msg2glo_ephem(const gnss_comm::msg::GnssGloEphemMsg & gnss_glo_ephem_msg);
    ...
    * args   : const GnssMeasMsg & gnss_meas_msg      I   GNSS measurement message
    * return : cooresponding GNSS measurements
    *-----------------------------------------------------------------------------*/
    std::vector<ObsPtr> msg2meas(const gnss_comm::msg::GnssMeasMsg & gnss_meas_msg);
    ...
    * args   : const GnssTimePulseInfoMsg & gnss_tp_info_msg   I   GNSS time pulse message
    * return : cooresponding GNSS time pulse information
    *-----------------------------------------------------------------------------*/
    TimePulseInfoPtr msg2tp_info(const gnss_comm::msg::GnssTimePulseInfoMsg & gnss_tp_info_msg);
    ...
    * args   : const GnssPVTSolnMsg & pvt_msg   I   GNSS PVT solution message
    * return : cooresponding GNSS PVT solution
    *-----------------------------------------------------------------------------*/
    PVTSolutionPtr msg2pvt(const gnss_comm::msg::GnssPVTSolnMsg & pvt_msg);
